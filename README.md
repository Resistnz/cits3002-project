...
# Structure
Our simulation uses `Hosts` and `Routers` that communicate via functions in the Layer classes (`TransportLayer`, `NetworkLayer` and `DataLinkLayer` as defined in `protocols.py`).
